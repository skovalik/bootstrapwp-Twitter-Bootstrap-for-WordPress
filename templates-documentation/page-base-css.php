...
<div class="container">
  <div class="row">
    <div class="span3 bs-docs-sidebar">
      <ul class="nav nav-list bs-docs-sidenav">
        <li>
          <a href="#global"> <i class="glyphicon-chevron-right"></i>
            Global styles
          </a>
        </li>
        <li>
          <a href="#gridSystem"> <i class="glyphicon-chevron-right"></i>
            Grid system
          </a>
        </li>
        <li>
    ...
    <div class="span9">
      ...
      <section id="global">
        ...
        <p>
          With Bootstrap 2, the old reset block has been dropped in favor of
          <a href="http://necolas.github.com/normalize.css/" target="_blank">Normalize.css</a>
          , a project by
          <a href="http://twitter.com/necolas" target="_blank">Nicolas Gallagher</a>
          and
          <a href="http://twitter.com/jon_neal" target="_blank">Jonathan Neal</a>
          that also powers the
          <a href="http://html5boilerplate.com" target="_blank">HTML5 Boilerplate</a>
          . While we use much of Normalize within our <strong>reset.less</strong>
      ...
      <section id="gridSystem">
        ...
        <p>
          The default Bootstrap grid system utilizes
          <strong>12 columns</strong>
          , making for a 940px wide container without
          <a href="./scaffolding.html#responsive">responsive features</a>
  ...
  <section id="forms">
    ...
    <ul>
      ...
      <li>
        Wrap any associated controls in
        <code>.controls</code>
    ...
    <form class="bs-docs-example form-inline">
      <input type="text" placeholder="Text input"></form>
    ...
    <form class="bs-docs-example">
      <div class="input-prepend">
        ...
        <input id="prependedInput" type="text" placeholder="Username"></div>
      <br>
    ...
    <form class="bs-docs-example">
      <div class="input-prepend">
        ...
        <!-- /btn-group -->
        <input class="span2" id="prependedDropdownButton" type="text"></div>
      <!-- /input-prepend --> </form>
    <pre class="prettyprint linenums">
            &lt;div class="input-prepend"&gt;
            &lt;div class="btn-group"&gt;
    ...
    <form class="bs-docs-example">
      <div class="input-prepend input-append">
        ...
        <!-- /btn-group --> </div>
      <!-- /input-prepend input-append --> </form>
    <pre class="prettyprint linenums">
            &lt;div class="input-prepend input-append"&gt;
            &lt;div class="btn-group"&gt;
            &lt;button class="btn dropdown-toggle" data-toggle="dropdown"&gt;
    ...
    <form class="bs-docs-example" style="padding-bottom: 15px;">
      <div class="controls">
        <input class="input-block-level" type="text" placeholder=".input-block-level"></div>
    </form>
    <pre class="prettyprint linenums">
    ...
    <form class="bs-docs-example" style="padding-bottom: 15px;">
      <div class="controls docs-input-sizes">
        ...
        <input class="input-mini" type="text" placeholder=".input-mini"></div>
    </form>
    <pre class="prettyprint linenums">
            &lt;input class="input-large" type="text" placeholder=".input-large"&gt;
            &lt;input class="input-small" type="text" placeholder=".input-small"&gt;
    ...
    <p>
      For multiple grid inputs per line,
      <strong>use the
        <code>.controls-row</code>
        modifier class for proper spacing</strong>
      . It floats the inputs to collapse white-space, sets the proper margins, and the clears the float.
    </p>
    <form class="bs-docs-example" style="padding-bottom: 15px;">
      <div class="controls controls-row">
        <input class="span5" type="text" placeholder=".span5"></div>
      <div class="controls controls-row">
        <input class="span4" type="text" placeholder=".span4">
        <input class="span1" type="text" placeholder=".span1"></div>
      <div class="controls controls-row">
        <input class="span3" type="text" placeholder=".span3">
        <input class="span2" type="text" placeholder=".span2"></div>
      <div class="controls controls-row">
        <input class="span2" type="text" placeholder=".span2">
        <input class="span3" type="text" placeholder=".span3"></div>
      <div class="controls controls-row">
        <input class="span1" type="text" placeholder=".span1">
        <input class="span4" type="text" placeholder=".span4"></div>
    </form>
    <pre class="prettyprint linenums">
            &lt;div class="controls"&gt;
    ...
    <form class="bs-docs-example form-inline">
      <input class="input-xlarge focused" id="focusedInput" type="text" value="This is focused..."></form>
    <pre class="prettyprint linenums">
    ...
    <form class="bs-docs-example form-inline">
      <input class="span3" type="email" placeholder="test@example.com" required></form>
    <pre class="prettyprint linenums">&lt;input class="span3" type="email" required&gt;</pre>
    ...
    <form class="bs-docs-example form-inline">
      <input class="input-xlarge" id="disabledInput" type="text" placeholder="Disabled input here…" disabled></form>
    <pre class="prettyprint linenums">
    ...
    <p>
      Bootstrap includes validation styles for error, warning, info, and success messages. To use, add the appropriate class to the surrounding
      <code>.control-group</code>
      .
    </p>
  ...
  <section id="images">
    ...
    <div class="bs-docs-example bs-docs-example-images">
      ...
      <img data-src="holder.js/140x140" class="img-polaroid"></div>
    <pre class="prettyprint linenums">
    ...
    <p>
      ...
      do not work in IE8 due to lack of
  ...
  <section id="icons">
    ...
    <p>
      Bootstrap comes with all 160 of
      <a href="http://glyphicons.com" target="_blank">Glyphicons</a>
      Halflings set, all available in font formats for easy coloring, sizing, and placement.
    </p>
    ...
    <ul class="the-icons clearfix">
      ...
      <li>
        <i class="glyphicon-download-alt"></i>
      ...
      <li>
        <i class="glyphicon-play-circle"></i>
      ...
      <li>
        <i class="glyphicon-volume-off"></i>
      ...
      <li>
        <i class="glyphicon-text-width"></i>
        glyphicon-text-width
      </li>
      <li>
        <i class="glyphicon-align-left"></i>
        glyphicon-align-left
      </li>
      <li>
        <i class="glyphicon-align-center"></i>
        glyphicon-align-center
      </li>
      <li>
        <i class="glyphicon-align-right"></i>
        glyphicon-align-right
      </li>
      <li>
        <i class="glyphicon-align-justify"></i>
      ...
      <li>
        <i class="glyphicon-indent-left"></i>
        glyphicon-indent-left
      </li>
      <li>
        <i class="glyphicon-indent-right"></i>
      ...
      <li>
        <i class="glyphicon-step-backward"></i>
      ...
      <li>
        <i class="glyphicon-fast-forward"></i>
        glyphicon-fast-forward
      </li>
      <li>
        <i class="glyphicon-step-forward"></i>
      ...
      <li>
        <i class="glyphicon-remove-circle"></i>
        glyphicon-remove-circle
      </li>
      <li>
        <i class="glyphicon-ok-circle"></i>
        glyphicon-ok-circle
      </li>
      <li>
      ...
      <li>
        <i class="glyphicon-arrow-left"></i>
      ...
      <li>
        <i class="glyphicon-folder-close"></i>
      ...
      <li>
        <i class="glyphicon-resize-vertical"></i>
        glyphicon-resize-vertical
      </li>
      <li>
        <i class="glyphicon-resize-horizontal"></i>
      ...
      <li>
        <i class="glyphicon-hand-right"></i>
        glyphicon-hand-right
      </li>
      <li>
        <i class="glyphicon-hand-left"></i>
        glyphicon-hand-left
      </li>
      <li>
        <i class="glyphicon-hand-up"></i>
        glyphicon-hand-up
      </li>
      <li>
      ...
      <li>
        <i class="glyphicon-circle-arrow-right"></i>
        glyphicon-circle-arrow-right
      </li>
      <li>
        <i class="glyphicon-circle-arrow-left"></i>
        glyphicon-circle-arrow-left
      </li>
      <li>
        <i class="glyphicon-circle-arrow-up"></i>
        glyphicon-circle-arrow-up
      </li>
      <li>
        <i class="glyphicon-circle-arrow-down"></i>
      ...
      <li>
        <i class="glyphicon-sort-by-alphabet-alt"></i>
        glyphicon-sort-by-alphabet-alt
      </li>
      <li>
        <i class="glyphicon-sort-by-order"></i>
        glyphicon-sort-by-order
      </li>
      <li>
        <i class="glyphicon-sort-by-order-alt"></i>
        glyphicon-sort-by-order-alt
      </li>
      <li>
        <i class="glyphicon-sort-by-attributes"></i>
        glyphicon-sort-by-attributes
      </li>
      <li>
        <i class="glyphicon-sort-by-attributes-alt"></i>
      ...
      <li>
        <i class="glyphicon-collapse-top"></i>
    ...
    <p>
      ...
      Halflings are normally not available for free, but an arrangement between Bootstrap and the Glyphicons creator have made this possible at no cost to you as developers. As a thank you, we ask you to include an optional link back to
      <a href="http://glyphicons.com/">Glyphicons</a>
      whenever practical.
    </p>
    ...
    <h2>How to use</h2>
    <p>
      Add the appropriate class to any inline element. All icon classes are prefixed with
      <code>glyphicon-</code>
      for easy styling. To use, place the following code just about anywhere:
    </p>
    <pre class="prettyprint linenums">&lt;i class="glyphicon-search"&gt;&lt;/i&gt;</pre>
    <p>
      Want to change the icon color? Just change the
      <code>color</code>
    ...
    <div class="bs-docs-example">
      <div class="btn-group">
        <a class="btn btn-primary" href="#">
          <i class="glyphicon-user icon-white"></i>
          User
        </a>
    ...
    <div class="bs-docs-example">
      <div class="well" style="padding: 8px 0; margin-bottom: 0;">
        <ul class="nav nav-list">
          <li class="active">
            <a href="#">
              <i class="glyphicon-home icon-white"></i>
              Home
            </a>
          </li>
          <li>
      ...
      <div class="control-group">
        ...
        <div class="controls">
          <div class="input-prepend">
            ...
            <input class="span2" id="inputIcon" type="text"></div>
        </div>
      </div>
    </form>
    <pre class="prettyprint linenums">
  ...
  <section id="responsive">
    ...
    <p>
      Responsive CSS requires the following meta tag in the
      <code>&lt;head&gt;</code>
      of your pages.
    </p>
    <pre class="prettyprint linenums">
